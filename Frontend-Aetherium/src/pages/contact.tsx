...
import { MdHome, MdOutlinePhoneCallback, MdEmail, MdOutlineInfo   } from "react-icons/md";
                  ...
                  <div className="">
                    <ul className="ps-0">
                      <li className="mb-3 d-flex gap-15 align-items-center">
                        <MdHome/>
                        <address className="mb-0">Somewhere on wallstreet, afghanistan, fuji mountain, on your left</address>
                      </li>
                      <li className="mb-3 d-flex gap-15 align-items-center">
                      ...
                      <li className="mb-3 d-flex gap-15 align-items-center">
                        <MdEmail />
                        <a href="mailto:lamoukfesoy@gmail.com">lamoukfesoy@gmail.com</a>
                      </li>
                      <li className="mb-3 d-flex gap-15 align-items-center">
                        <MdOutlineInfo />
